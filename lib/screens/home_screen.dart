...
class _HomeScreenState extends ConsumerState<HomeScreen> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    final openGames = gamesState.games.where((game) => game.status == GameStatus.open).toList();
    final closedGames = gamesState.games.where((game) => game.status == GameStatus.closed).toList();
