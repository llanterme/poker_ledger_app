...
class _AddTransactionScreenState extends ConsumerState<AddTransactionScreen> {
  ...
  Future<void> _checkExistingTransactions() async {
    ...
    final hasEndAmount = transactions.any((t) => 
    ...
    if (hasEndAmount) {
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('End amount already recorded. No more transactions allowed for this player.'),
  ...
  Future<void> _addTransaction() async {
    ...
    try {
      ...
      await Future.delayed(Duration.zero, () async {
        await ref.read(gameTransactionsProvider.notifier).addTransaction(transaction);
      });
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    RadioListTile<TransactionType>(
                      ...
                      subtitle: const Text('Final cash out amount (can be negative)'),
                      value: TransactionType.gameEndAmount,
                      groupValue: _selectedType,
                      onChanged: _hasEndAmount
                          ? null
                          : (value) {
                              setState(() {
                                _selectedType = value!;
              ...
              CustomTextField(
                label: 'Amount',
                hint: _selectedType == TransactionType.gameEndAmount 
                ...
                validator: (value) {
                  ...
                  try {
                    ...
                    if (_selectedType != TransactionType.gameEndAmount && amount <= 0) {
                ...
                onChanged: (value) {
                  ...
                  if (_selectedType == TransactionType.gameEndAmount) {
                    ...
                    if (parts.length > 2) {
                      String formattedValue = '${parts[0]}.${parts.sublist(1).join('')}';
                    ...
                    if (parts.length > 2) {
                      final formattedValue = '${parts[0]}.${parts.sublist(1).join('')}';
                      _amountController.value = TextEditingValue(
                        text: formattedValue,
                        selection: TextSelection.collapsed(offset: formattedValue.length),
                      );
                ...
                children: [
                  ...
                  Expanded(
                    child: CustomButton(
                      ...
                      gradient: _selectedType == TransactionType.gameEndAmount
