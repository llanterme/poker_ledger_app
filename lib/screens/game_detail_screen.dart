...
class _GameDetailScreenState extends ConsumerState<GameDetailScreen>
  ...
  Future<void> _closeGame() async {
    ...
    final usersWithEndAmounts =
        transactionsState.transactions
            .where((t) => t.type == TransactionType.gameEndAmount)
            .map((t) => t.userId)
            .toList();

    final missingEndAmounts =
        allUserIds.where((id) => !usersWithEndAmounts.contains(id)).toList();

    if (missingEndAmounts.isNotEmpty) {
      final missingUsers = missingEndAmounts
          .map((id) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            'Cannot close game: Missing end amounts for $missingUsers',
          ),
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        bottom: TabBar(
          ...
          tabs: const [Tab(text: 'PLAYERS'), Tab(text: 'SUMMARY')],
  ...
  Widget _buildPlayersTab(
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        final totals =
            userTotals[user.id] ??
            {'buyInTotal': 0.0, 'endAmount': 0.0, 'netProfit': 0.0};
        ...
        final hasEndAmount = transactions.any(
          (t) => t.type == TransactionType.gameEndAmount,
        );
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 16),
                Text('Transactions', style: AppTheme.labelLarge),
                const SizedBox(height: 8),
  ...
  Widget _buildSummaryTab(
    ...
    final createdDate =
        game.createdAt != null ? dateFormat.format(game.createdAt!) : 'Unknown';
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 24),
          Text('Player Results', style: AppTheme.titleLarge),
          const SizedBox(height: 16),
